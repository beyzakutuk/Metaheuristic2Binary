function [bestSolution, bestFitness, iteration]=sfs(fhd, dimension, maxIteration, fNumber)
...
function [createPoint, fitness] = Diffusion_Process(Point,S,g,BestPoint,fhd,fNumber)
