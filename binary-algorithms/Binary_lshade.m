function [bestSolution, bestFitness, iteration]=Binary_lshade(fhd, dimension, maxIteration, fNumber,T_num)
...
func = fNumber;
    ...
    BinaryPop = zeros(pop_size, problem_size);
    for i = 1:pop_size
    ...
    for i = 1:pop_size
      fitness(i) = testFunction(BinaryPop(i,:)', fhd, func);
    end
...
%%      if nfes > max_nfes; exit(1); end
    ...
    %  BURAYI GÜNCELLEDİK !!
    BinaryUi = zeros(pop_size, problem_size);
    for i = 1:pop_size
    ...
    for i = 1:pop_size
        children_fitness(i) = testFunction(BinaryUi(i,:)', fhd, func);
    end
