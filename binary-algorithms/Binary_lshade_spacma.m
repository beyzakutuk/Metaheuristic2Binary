function [bestSolution, bestFitness, iteration]=Binary_lshade_spacma(fhd, dimension, maxIteration, fNumber, T_num)
...
func = fNumber;
            ...
            %fitness = testFunction(pop', fhd, func);   % BURAYI GÜNCELLEDİK !!
            ...
            while nfes < max_nfes
                ...
                %children_fitness = testFunction(ui', fhd, func);   %  BURAYI GÜNCELLEDİK !!    
                ...
                % --- Hatanın çıktığı kısımın hemen öncesinde boyutları sabitle
                Child_is_better_index = reshape(Child_is_better_index, [], 1);
                Class_Select_Index = reshape(Class_Select_Index, [], 1);
                dif = reshape(dif, [], 1);
                
                % --- Doğrudan & operatörü kullanarak:
                ...
                BinaryPop(Child_is_better_index == 2, :) = BinaryUi(Child_is_better_index == 2, :);   %  BURAYI GÜNCELLEDİK !!
